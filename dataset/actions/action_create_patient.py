...
class ActionCreatePatient(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,
        ...
        text = f"You have requested for an appointment with the following details:\n\n" +\
        ...
        return [ActionExecuted("action_listen"), UserUttered(text="/EXTERNAL_create_order", parse_data={"intent":{"name": "EXTERNAL_create_order"}}, input_channel="telegram")]
